...
public:
    ...
    WallFollowOutput execute(const Behavior::Data& data);

    void cancel();

private:
    using FeedbackMsg = create3_examples_msgs::action::WallFollow::Feedback;
    ...
    WallFollowOutput m_coverage_output;
    create3_examples_msgs::action::WallFollow::Goal m_goal;
